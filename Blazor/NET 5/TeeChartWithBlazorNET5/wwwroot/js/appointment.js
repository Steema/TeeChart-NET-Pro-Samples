    ...
    tip.ongettext = function (tool, text, series, index) {
        ...
        for (t = 0; t < aChart.series.count(); t++) {
            ...
            if (!Number.isNaN(ser.data.values[index])) {
                s += "<br/>";
                s += '<font face="verdana" color="#004000" size="1"><b>' + ser.title + ':</b></font> <font face="verdana" color="red" size="1">' + aChart.axes.left.labels.formatValueString(ser.data.values[index]) + '</font>';
            }
        }
        return s;
    }
