...
using WebAppNETCore3.Models;

namespace WebAppNETCore3.Controllers
{
    public class HomeController : Controller
    {
        private static readonly object s_renderLock = new object();

        MemoryStream _tempStream1;
        MemoryStream _tempStream2;
            ...
            lock (s_renderLock)
            {
              ...
              "}"
                    ...
                    else if (type == 1)
                    {
                        ...
                        wChart3.Series[0].Marks.Visible = false;
					...
					wChart3.Series[0].XValues.DateTime = true;
					...
					for (int i = 0; i < 60; i++)
					{
						if (((i < 4) || (i > 13)) &&
								...
								((i < 25) || (i > 28)))
						{
							wChart3.Series[0].Add(ddate, rand.Next(20));
						}

						ddate++;
					}

					wChart3.Axes.Bottom.Labels.DateTimeFormat = "dd/mm/yyyy HH:MM:ss";
