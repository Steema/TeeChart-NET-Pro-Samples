...
namespace WebDemo.Chart_Styles.Extended
{
  public class Grid3DUtils
  {
    ...
    private static double ClosestValue(Steema.TeeChart.Styles.Custom3D src, double x, double z)
    {
    ...
    public static void CreateGrid(Steema.TeeChart.Styles.Custom3D src, Steema.TeeChart.Styles.Custom3DGrid dst, int gridsize)
    { 
    ...
    public static void SmoothGrid(Steema.TeeChart.Styles.Custom3DGrid series)
    { 
      double tmpx, tmpz, tmpy;
