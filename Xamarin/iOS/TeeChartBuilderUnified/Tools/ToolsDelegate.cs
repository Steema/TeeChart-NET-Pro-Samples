		...
		public override void RowSelected(UITableView tableView, NSIndexPath indexPath)
		{
			...
			switch (row)
			{
				...
				case 3:
				    ...
				    (_controller.chart.Tools[_controller.chart.Tools.Count-1] as Steema.TeeChart.Tools.GridBand).Band1.Color = Color.Gray;
				    (_controller.chart.Tools[_controller.chart.Tools.Count-1] as Steema.TeeChart.Tools.GridBand).Band2.Color = Color.DarkGray;				
					break;
				case 4:
				...
				case 6:
					...
					(_controller.chart.Tools[_controller.chart.Tools.Count-1] as Steema.TeeChart.Tools.ColorLine).Pen.Color = Color.Red;
					break;
				case 7:			
				    _controller.chart.Chart.Series.RemoveAllSeries();
					_controller.chart.Chart.Aspect.ClipPoints=true;
					...
					(_controller.chart.Tools[_controller.chart.Tools.Count-1] as Steema.TeeChart.Tools.ColorBand).Pen.Color = Color.Red;
					break;
				case 8:
				    _controller.chart.Chart.Aspect.ZoomScrollStyle=Steema.TeeChart.Drawing.Aspect.ZoomScrollStyles.Manual;				
				...
				case 10:
					...
					(_controller.chart.Tools[_controller.chart.Tools.Count-1] as Steema.TeeChart.Tools.SeriesRegionTool).Color = Color.Yellow;
