...
namespace XamControls.Droid
{
    public class SearchPageRenderer : PageRenderer
    {
        ...
        public AndroidX.AppCompat.Widget.Toolbar _toolBar;

        public SearchView _searchView;

        public AndroidX.AppCompat.Widget.ActionMenuView actionMenuView;
        public AndroidX.AppCompat.Widget.AppCompatImageButton appCompatImageButton;
        public AndroidX.AppCompat.Widget.AppCompatTextView appCompatTextView;
        ...
        {
            AndroidX.AppCompat.Widget.AppCompatImageButton search = null;

            for (int i = 0; i < _toolBar.ChildCount; i++)
            {

                if (_toolBar.GetChildAt(i) is AndroidX.AppCompat.Widget.AppCompatImageButton) { search = (AndroidX.AppCompat.Widget.AppCompatImageButton)_toolBar.GetChildAt(i); }
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<Page> e)
        {
            ...
            _toolBar = ((Android.App.Activity)_localContext).FindViewById<AndroidX.AppCompat.Widget.Toolbar>(Resource.Id.toolbar);
        ...
        public void AddSearchToToolBar()
        {
            ...
            if (_toolBar?.GetChildAt(1) is AndroidX.AppCompat.Widget.AppCompatTextView)
            {
                actionMenuView = (AndroidX.AppCompat.Widget.ActionMenuView)_toolBar?.GetChildAt(0);
                appCompatTextView = (AndroidX.AppCompat.Widget.AppCompatTextView)_toolBar?.GetChildAt(1);
                appCompatImageButton = (AndroidX.AppCompat.Widget.AppCompatImageButton)_toolBar?.GetChildAt(2);
            ...
            else
            {
                ...
                actionMenuView = (AndroidX.AppCompat.Widget.ActionMenuView)_toolBar?.GetChildAt(0);
                appCompatImageButton = (AndroidX.AppCompat.Widget.AppCompatImageButton)_toolBar?.GetChildAt(1);
                appCompatTextView = (AndroidX.AppCompat.Widget.AppCompatTextView)_toolBar?.GetChildAt(2);
        ...
        public void InitializeSearchView()
        {
            ...
            var vsearch1_3_1 = (AndroidX.AppCompat.Widget.AppCompatImageView)sViewUnderLayout.GetChildAt(0);
            ...
            var textView = (AndroidX.AppCompat.Widget.AppCompatAutoCompleteTextView)textViewLayout.GetChildAt(0);
            ...
            var search = ((actionMenuView?.FindViewById<AndroidX.AppCompat.View.Menu.ActionMenuItemView>(Resource.Id.action_search))?.ItemData as AndroidX.AppCompat.View.Menu.MenuItemImpl)?.SetActionView(_searchView);

        }

        private void TextView_Click(object sender, EventArgs e)
        {
            var tView = sender as AndroidX.AppCompat.Widget.AppCompatAutoCompleteTextView;
    ...
    public class OnSearchClickListener : FormsAppCompatActivity, Android.Views.View.IOnClickListener
    {
        ...
        {
            var view1 = (AndroidX.AppCompat.Widget.ActionMenuView)_searchPageRenderer._toolBar.GetChildAt(0);
            ...
            var backButton = (AndroidX.AppCompat.Widget.AppCompatImageButton)_searchPageRenderer._toolBar.GetChildAt(1);
    ...
    public class OnCloseClickListener : FormsAppCompatActivity, Android.Views.View.IOnClickListener
    {
        ...
        public void OnClick(Android.Views.View v)
        {
            ...
            var search = ((_searchPageRenderer.actionMenuView?.FindViewById<AndroidX.AppCompat.View.Menu.ActionMenuItemView>(Resource.Id.action_search))?.ItemData as AndroidX.AppCompat.View.Menu.MenuItemImpl)?.CollapseActionView();
        }
