...
namespace XamControls.Droid
{
	...
	{
        public static AndroidX.AppCompat.Widget.Toolbar ToolBar { get; set; }
		...
		protected override void OnCreate(Bundle bundle)
		{
            ...
            ToolBar = (AndroidX.AppCompat.Widget.Toolbar)FindViewById(Resource.Layout.Toolbar);
            ...
            Steema.TeeChart.TChart.Init(this, bundle);
