...
namespace XamControls.Charts.Functions.Pro.Statistical
{
    public class SPCProFunctionChart : SeriesModel
    {
		...
		public SPCProFunctionChart(ChartView BaseChart)
		{
			...
			BaseChart.Chart.Header.Text = "Quality Control";
		...
		{
			lineGood.Pointer.Visible = true;
			lineBad.Pointer.Visible = true;
			Random r = new Random();
			for (int i = 1; i < 19; i++)
			{
				lineGood.Add(800 + r.Next(200)); // good
				lineBad.Add(4 + r.Next(4)); // bad
			}
