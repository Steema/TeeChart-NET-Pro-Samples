...
{
    public class DivStdFunctionsChart : SeriesModel
    {
		...
		public DivStdFunctionsChart(ChartView BaseChart)
		{
			...
			theDivLine.Color = var.GetPaletteBasic[2];
            ...
            bar1.Marks.Height += 4;
            // TODO PEP bar1.Marks.TextAlign = TextAlignment.Center;
            bar1.Marks.Color = Xamarin.Forms.Color.Transparent;
            bar1.Marks.Font.Color = Color.White;

            bar2.Marks.Font.Size = 14;
            bar2.Marks.TailStyle = MarksTail.None;
            // TODO PEP bar2.Marks.TextAlign = TextAlignment.Center;
            bar2.Marks.Color = Xamarin.Forms.Color.Transparent;
            bar2.Marks.Height += 4;
            ...
            // TODO PEP theDivLine.Marks.Pen.Color = theDivLine.Color.AddLuminosity(-0.3);
