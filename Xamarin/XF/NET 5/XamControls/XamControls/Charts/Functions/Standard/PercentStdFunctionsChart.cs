...
namespace XamControls.Charts.Functions.Standard
{
    public class PercentStdFunctionsChart : SeriesModel
    {
		...
		public PercentStdFunctionsChart(ChartView BaseChart)
		{
			...
			thePercentLine.Color = var.GetPaletteBasic[2];
            ...
            // TODO PEP thePercentLine.LinePen.DashCap = PenLineCap.Round;
            // TODO PEP thePercentLine.LinePen.EndCap = PenLineCap.Round;
            ...
            // TODO PEP area.LinePen.Color = area.Color.AddLuminosity(-0.2);
            area.LinePen.Width = 5;
			area.LinePen.Transparency = 50;
			area.AreaLines.Width = 0;
			area.AreaLines.Transparency = 100;
			area.AreaLines.Width = 1;
			area.AreaLines.Visible = true;

            // TODO PEP BaseChart.Chart.Series[0].Marks.TextAlign = TextAlignment.Center;
