...
namespace XamControls.Charts.Linear_Gauge
{
    public class BatteryLinearChart
    {
		...
		public BatteryLinearChart(ChartView BaseChart)
		{
            ...
            // TODO PEP linearGauge.Ticks.HorizSize = 2.5;
			...
			linearGauge.Marks.Color = Color.White;
		...
		{
            // TODO PEP g.Font.Size = 22;
            // TODO PEP g.RotateLabel(linearGauge.Chart.ChartRect.Center.Y - 210, linearGauge.Chart.ChartRect.Center.X + 85, Math.Round((100 - Convert.ToDouble(linearGauge.Value)), 2).ToString() + " %", 90);
        }
