    ...
    public class CarFuelChart
    {
		...
		public CarFuelChart(ChartView BaseChart)
		{
			...
			circularGauge.GreenLine.Gradient.EndColor = Xamarin.Forms.Color.LightGreen;
             // TODO PEP circularGauge.GreenLine.Gradient.Direction = Steema.TeeChart.Drawing.GradientDirection.FromBottomLeft;
			...
			circularGauge.Frame.MiddleBand.Gradient.EndColor = Xamarin.Forms.Color.FromRgb(20, 20, 20);
             // TODO PEP circularGauge.Frame.MiddleBand.Gradient.Direction = Steema.TeeChart.Drawing.GradientDirection.DiagonalDown;
        ...
        private void Chart_AfterDraw(object sender, IGraphics3D g)
        {
            var chart = sender as ChartView;

            // TODO PEP g.Rectangle(new Xamarin.Forms.Rectangle() { Width = 100, Height = 100, });
