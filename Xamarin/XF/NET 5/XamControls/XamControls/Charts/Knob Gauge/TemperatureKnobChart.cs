...
namespace XamControls.Charts.Knob_Gauge
{
    class TemperatureKnobChart
    {
            ...
            // TODO PEP knobGauge.RedLine.Gradient.Direction = Steema.TeeChart.Drawing.GradientDirection.TopBottom;
            ...
            // TODO PEP knobGauge.GreenLine.Gradient.Direction = Steema.TeeChart.Drawing.GradientDirection.BottomTop;
            knobGauge.GreenLine.Gradient.StartColor = Color.FromRgb(192, 255, 255);
					...
					knobGauge.Axis.Labels.OnAxis = false;
            ...
            // TODO PEP annotationCold.Left = BaseChart.Width / 4;
            // TODO PEP annotationCold.Top = (((BaseChart.Parent as StackLayout).Parent as Grid).Parent as ContentPage).Height + 250;
            ...
            // TODO PEP annotationHot.Left = BaseChart.Width + BaseChart.Width / 2;
            // TODO PEP annotationHot.Top = (((BaseChart.Parent as StackLayout).Parent as Grid).Parent as ContentPage).Height + 250;
