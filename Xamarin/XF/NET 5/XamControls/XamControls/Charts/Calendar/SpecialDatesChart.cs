...
namespace XamControls.Charts.Calendar
{
	public partial class SpecialDatesChart
	{
		...
		public SpecialDatesChart(ChartView BaseChart, Label label)
		{
            ...
            BaseChart.Chart.Header.TextAlign = StringAlignment.Far;
            ...
            calendar.WeekDays.TextAlign = StringAlignment.Near;
            calendar.WeekDays.Pen.Width = 1;
			calendar.WeekDays.UpperCase = true;
			calendar.Days.Font.Size = 14;
            calendar.Days.TextAlign = StringAlignment.Near;
            ...
            calendar.Pen.DashCap = DashCap.Round;
        ...
        private void Calendar_BeforeDrawValues(object sender, IGraphics3D g)
        {
            var item = sender as Steema.TeeChart.Styles.Calendar;
            System.Drawing.Rectangle rectangle = item.RectCell(1, 1);
