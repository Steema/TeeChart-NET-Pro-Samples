...
namespace XamControls.Charts.Standard
{
    public class ColumnBarChart
    {
				...
				public ColumnBarChart(ChartView BaseChart)
				{
						...
						bar1.Color = var.GetPaletteBasic[0];
						...
						bar2.Color = var.GetPaletteBasic[1];
						...
						bar3.Color = var.GetPaletteBasic[2];
            ...
            // TODO PEP BaseChart.Chart.Series[0].Marks.TextAlign = Xamarin.Forms.TextAlignment.Center;
            BaseChart.Chart.Series[0].Marks.AutoSize = true;
						BaseChart.Chart.Series[0].Marks.Color = Color.Transparent;
            // TODO PEP BaseChart.Chart.Series[1].Marks.TextAlign = Xamarin.Forms.TextAlignment.Center;
            BaseChart.Chart.Series[1].Marks.AutoSize = true;
						BaseChart.Chart.Series[1].Marks.Color = Color.Transparent;
            // TODO PEP BaseChart.Chart.Series[2].Marks.TextAlign = Xamarin.Forms.TextAlignment.Center;
            BaseChart.Chart.Series[2].Marks.AutoSize = true;
				...
				public void Chart_ClickSeries(object sender, Series s, int valueIndex, Steema.TeeChart.Drawing.MouseEventArgs e)
				{
						...
						if (BaseChart.Chart.Header.Text == "Civil status of people in the bus")
						{
							...
							*/
							...
							Bar bar = (Bar)Serie;
                // TODO PEP bar.Pen.Color = bar.Color.AddLuminosity(-0.3);
                bar.Pen.Width = 3;
            ...
            // TODO PEP for(int i = 0; i < BaseChart.Chart.Series.Count; i++) { ((Bar)BaseChart.Chart.Series[i]).Pen.Width = 1; ((Bar)BaseChart.Chart.Series[i]).Pen.Color.AddLuminosity(0.3); }
