...
namespace XamControls.Charts.Standard
{
    public class BubbleChart
    {
			...
			public BubbleChart(ChartView BaseChart)
			{
					...
					bubble1.Color = var.GetPaletteBasic[0];
            ...
            // TODO PEP bubble1.ClickPointer += tool_dataPointSelect.PointValue_Click;
            bubble1.GetSeriesMark += tool_dataPointSelect.Serie_GetSeriesMark;
					for (int i = 0; i < var.GetValorBubble1.Length; i++) {
					bubble1.Add(var.GetValorBubbleX[i], var.GetValorBubble1[i], var.GetValorBubble1[i]/4, var.GetPaletteBasic[i]); }
            ...
            // TODO PEP BaseChart.Chart.Axes.Left.Title.Alignment = Xamarin.Forms.TextAlignment.Center;

            BaseChart.Chart.Axes.Left.Visible = true;
					BaseChart.Chart.Axes.Left.AxisPen.Visible = true;
            // TODO PEP BaseChart.Chart.Axes.Left.Ticks = new Axis.TicksPen { Width = 2, Visible = true, Color = Color.FromArgb(200, 200, 200), EndCap = PenLineCap.Flat, Style = DashStyle.Solid, Length = 10, };
            ...
            // TODO PEP BaseChart.Chart.ClickSeries -= Chart_ClickSeries;

            // Themes Marks
            Themes.AplicarMarksTheme1(BaseChart);

					bubble1.Marks.ArrowLength = 0;
            // TODO PEP bubble1.Marks.TextAlign = Xamarin.Forms.TextAlignment.Center;
            bubble1.Marks.Font.Color = Color.Black;
					bubble1.Marks.Font.Size = 19;
					bubble1.Marks.Pen.Width = 65;
					bubble1.Marks.Width = 60;
					bubble1.Marks.Pen.Visible = true;
					bubble1.Marks.Transparent = false;
					bubble1.Marks.Pen.Color = Color.White;
					bubble1.Marks.Transparency = 0;
					bubble1.Marks.Color = Color.White;
					bubble1.Marks.Pen.Visible = true;
					bubble1.Marks.Pen.Width = 2;
					bubble1.Marks.Pen.Color = Color.Black;
					bubble1.Marks.Pen.Transparency = 0;
					bubble1.Marks.ShapeStyle = TextShapeStyle.RoundRectangle;
			...
			public void Chart_ClickSeries(object sender, Series s, int valueIndex, MouseEventArgs e)
			{
				...
				if (BaseChart.Chart.Header.Text == "Percentage of animals in the zoo (%)")
				{
