...
namespace XamControls.Charts.Standard
{
    public class StackAreaChartFeatures
    {
		...
		public StackAreaChartFeatures(ChartView BaseChart)
		{
            ...
            area1.LinePen.EndCap = LineCap.Flat;
            area1.LinePen.DashCap = DashCap.Flat;
            area1.LinePen.Color = var.GetPaletteBasic[0].AddLuminosity(-0.2);
			area1.ClickTolerance = 30;
            area1.ClickPointer += Area1_ClickPointer;
            ...
            area2.LinePen.EndCap = LineCap.Flat;
            area2.LinePen.DashCap = DashCap.Flat;
            ...
            area2.ClickPointer += Area2_ClickPointer; ;
            ...
            BaseChart.Chart.Axes.Bottom.Labels.TextAlign = StringAlignment.Near;
        ...
        private void Area2_ClickPointer(CustomPoint Series, int valueIndex, int x, int y)
        {
        }

        private void Area1_ClickPointer(CustomPoint Series, int valueIndex, int x, int y)
        {
        }
    }
}
