...
namespace XamControls.Charts.Standard
{
    public class GradientBarChartFeatures
    {
		...
		public GradientBarChartFeatures(ChartView BaseChart)
		{
            ...
            // bar1.Gradient.Direction = Graphics3DBase.GradientDirection;
            ...
            // TODO PEP bar2.Gradient.Direction = GradientDirection.TopBottom;
            ...
            BaseChart.Chart.Series[0].Marks.TextAlign = StringAlignment.Center;
            BaseChart.Chart.Series[0].Marks.AutoSize = true;
			BaseChart.Chart.Series[0].Marks.Color = Color.Transparent;
            BaseChart.Chart.Series[1].Marks.TextAlign = StringAlignment.Center;
