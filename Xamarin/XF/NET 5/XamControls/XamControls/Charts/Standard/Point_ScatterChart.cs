...
namespace XamControls.Charts.Standard
{
    public class Point_ScatterChart
    {
		...
		public Point_ScatterChart(ChartView BaseChart)
		{
            ...
            point2.Pointer = new SeriesPointer(BaseChart.Chart, point2) { Color = var.GetPaletteBasic[1], InflateMargins = true, HorizSize = 11, VertSize = 11, Pen = new ChartPen { EndCap = LineCap.Round, Color = Xamarin.Forms.Color.White, Width = 5 }, Style = PointerStyles.Sphere };
            point2.Color = var.GetPaletteBasic[1];
            ...
            point3.Pointer = new SeriesPointer(BaseChart.Chart, point2) { Color = var.GetPaletteBasic[1], InflateMargins = true, HorizSize = 11, VertSize = 11, Pen = new ChartPen { EndCap = LineCap.Round, Color = Xamarin.Forms.Color.White, Width = 5 }, Style = PointerStyles.Sphere };
            point3.Color = var.GetPaletteBasic[2];
            ...
            point4.Pointer = new SeriesPointer(BaseChart.Chart, point2) { Color = var.GetPaletteBasic[1], InflateMargins = true, HorizSize = 11, VertSize = 11, Pen = new ChartPen { EndCap = LineCap.Round, Color = Xamarin.Forms.Color.White, Width = 5 }, Style = PointerStyles.Sphere };
            point4.Color = var.GetPaletteBasic[3];
