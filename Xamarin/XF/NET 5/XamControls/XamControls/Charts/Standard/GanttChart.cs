...
namespace XamControls.Charts.Standard
{
    public class GanttChart
    {
            ...
            // TODO PEP BaseChart.Chart.Axes.Left.Ticks = new TicksPen { Width = 2, Visible = true, Color = Color.White, EndCap = PenLineCap.Flat, Style = DashStyle.Solid, Length = 10, };
