...
namespace XamControls.Charts.Standard
{
    public class HorizontalBarChart
    {
		...
		public HorizontalBarChart(ChartView BaseChart)
		{
            ...
            // TODO PEP BaseChart.Chart.Axes.Left.Ticks = new Axis.TicksPen { Width = 2, Visible = true, Color = Color.White, EndCap = PenLineCap.Flat, Style = DashStyle.Solid, Length = 10, };
