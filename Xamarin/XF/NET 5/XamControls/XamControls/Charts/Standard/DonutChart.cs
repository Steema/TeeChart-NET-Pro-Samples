...
namespace XamControls.Charts.Standard
{
    public class DonutChart
    {
			...
			public DonutChart(ChartView BaseChart)
			{
				...
				donut1.Color = var.GetPaletteBasic[0];
            ...
            // TODO PEP BaseChart.Chart.Axes.Left.Ticks = new Axis.TicksPen { Width = 2, Visible = true, Color = Color.FromArgb(0, 200, 200, 200), EndCap = PenLineCap.Flat, Style = DashStyle.Solid, Length = 10, };
            BaseChart.Chart.Axes.Bottom.Visible = true;
				...
				donut1.Marks.Pen.Transparency = 100;
				BaseChart.Chart.Series[0].Marks.Font.Size = 18;
				donut1.MarksPie.InsideSlice = true;
            // TODO PEP BaseChart.Chart.ClickSeries += tool_dataPointSelect.DonutChart_ClickSeries;
