...
namespace XamControls.Charts.Standard
{
    public class AreaChart
    {
			...
			// Constructor
			public AreaChart(ChartView BaseChart)
			{
					...
					area1.Color = var.GetPaletteBasic[0];
					...
					// TODO PEP area1.LinePen.Style = DashStyle.Solid;
            // TODO PEP area1.LinePen.EndCap = PenLineCap.Flat;
            // TODO PEP area1.LinePen.DashCap = PenLineCap.Flat;
            area1.LinePen.Color = var.GetPaletteBasic[0].AddLuminosity(-0.2);
					area1.ClickTolerance = 30;
            // TODO PEP area1.ClickPointer += tool_dataPointSelect.PointValue_Click;
            area1.GetSeriesMark += tool_dataPointSelect.Serie_GetSeriesMark;
					...
					area2.Color = var.GetPaletteBasic[1];
            ...
            // TODO PEP area2.LinePen.EndCap = PenLineCap.Flat;
            // TODO PEP area2.LinePen.DashCap = PenLineCap.Flat;
            ...
            // TODO PEP area2.ClickPointer += tool_dataPointSelect.PointValue_Click;
            ...
            // TODO PEP BaseChart.Chart.Axes.Bottom.Labels.TextAlign = Xamarin.Forms.TextAlignment.Start;
            ...
            BaseChart.Chart.Axes.Left.Labels.OnAxis = true;
            ...
            // TODO PEP BaseChart.Chart.ClickSeries += null;
