...
namespace XamControls.Charts.Standard
{
	public class FLineRealTimeChartFeatures
	{
		...
		public FLineRealTimeChartFeatures(ChartView BaseChart)
		{
			...
			fastLine1.Color = var.GetPaletteBasic[0];
			...
			fastLine2.Color = var.GetPaletteBasic[var.GetPaletteBasic.Length-1];
            ...
            // TODO PEP BaseChart.Chart.Axes.Left.Title.Pen = new ChartPen { Color = Xamarin.Forms.Color.Black, Width = 15 };
            ...
            // TODO PEP BaseChart.Chart.Axes.Left.Ticks = new Axis.TicksPen { Width = 2, Visible = true, Color = Xamarin.Forms.Color.FromRgb(200, 200, 200), EndCap = PenLineCap.Flat, Style = DashStyle.Solid, Length = 10, };
            ...
            // TODO PEP BaseChart.Chart.AfterDraw += Chart_AfterDraw;
