...
namespace XamControls.Charts.Standard
{
    public class LineChart : SeriesModel
    {
		...
		public LineChart(ChartView BaseChart)
		{
            ...
            // TODO PEP BaseChart.Chart.BeforeDraw += Chart_BeforeDraw;
            ...
            // TODO PEP line1.Pointer.Pen.EndCap = PenLineCap.Round;
            ...
            // TODO PEP line1.ClickPointer += tool_dataPointSelect.PointValue_Click;
            ...
            // TODO PEP line2.LinePen = new ChartPen { Width = 6, Color = var.GetPaletteBasic[1], };
            // TODO PEP line2.Pointer = new SeriesPointer(BaseChart.Chart, line2) { Color = var.GetPaletteBasic[1], InflateMargins = true, HorizSize = 11, VertSize = 11, Pen = new ChartPen { EndCap = PenLineCap.Round, Color = Xamarin.Forms.Color.White, Width = 5 }, Style = PointerStyles.Sphere };
            ...
            // TODO PEP line2.ClickPointer += tool_dataPointSelect.PointValue_Click;
