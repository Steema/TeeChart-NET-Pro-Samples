...
namespace XamControls.Charts.Standard
{
    public class HorizontalAreaChart
    {
		...
		public HorizontalAreaChart(ChartView BaseChart)
		{
				...
				horizArea1.Color = var.GetPaletteBasic[0];
                ...
                horizArea1.LinePen.EndCap = LineCap.Flat;
                horizArea1.LinePen.DashCap = DashCap.Flat;
				...
				BaseChart.Chart.Header.AutoSize = true;
