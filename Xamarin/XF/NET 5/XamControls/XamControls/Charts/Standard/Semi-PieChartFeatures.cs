...
{
    public class Semi_PieChartFeatures
    {
		private Pie pie1;
		...
		public Semi_PieChartFeatures(ChartView BaseChart)
		{
			...
			pie1.Color = var.GetPaletteBasic[0];
            ...
            pie1.CustomXRadius = (int)BaseChart.Chart.Axes.Bottom.MaxXValue;
            ...
            // TODO PEP BaseChart.Chart.Axes.Left.Ticks = new Axis.TicksPen { Width = 2, Visible = true, Color = Color.FromRgb(200, 200, 200), EndCap = PenLineCap.Flat, Style = DashStyle.Solid, Length = 10, };
            ...
            BaseChart.Chart.Legend.TextAlign = StringAlignment.Center;
			...
			pie1.Marks.Pen.Transparency = 100;
            ...
            if (App.ScreenWidth < 600) pie1.Marks.Font.Size = 15;
            else pie1.Marks.Font.Size = 18;
