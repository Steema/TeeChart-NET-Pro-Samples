...
namespace XamControls.Charts.Standard
{
    public class InterpolatingChartFeatures
    {
            ...
            // TODO PEP BaseChart.Chart.Axes.Bottom.Ticks = new Axis.TicksPen { Width = 2, Visible = true, Color = Color.FromArgb(200, 200, 200), EndCap = PenLineCap.Flat, Style = DashStyle.Solid, Length = 10, };
