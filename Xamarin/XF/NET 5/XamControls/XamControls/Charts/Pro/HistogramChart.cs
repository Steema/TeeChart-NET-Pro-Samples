...
namespace XamControls.Charts.Pro
{
    public class HistogramChart
    {
		...
		public HistogramChart(ChartView BaseChart)
		{
            ...
            BaseChart.Chart.Header.Text = "Histogram";
			...
			histogram.Marks.Color = var.GetPaletteBasic[0].AddLuminosity(-0.2);
            ...
            // TODO PEP BaseChart.Chart.ClickSeries += tool_dataPointSelection.HistoSeries_Click;
