...
namespace XamControls.Charts.Pro
{
    public class InvertedPyramidChart
    {
        ...
        public InvertedPyramidChart(ChartView BaseChart)
        {
            ...
            BaseChart.Chart.Header.Text = "Inverted Pyramid Series";
            ...
            pyramid1.Color = var.GetPaletteBasic[0];
            ...
            // TODO PEP pyramid1.Pen.Style = DashStyle.Solid;
            ...
            BaseChart.Chart.Axes.Left.Inverted = true;
