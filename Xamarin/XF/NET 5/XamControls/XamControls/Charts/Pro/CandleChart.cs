...
namespace XamControls.Charts.Pro
{
    public class CandleChart
    {
		...
		public CandleChart(ChartView BaseChart)
		{
				...
				BaseChart.Chart.Header.Text = "Stock exchange about two companies";
		...
		private void Candle_GetPointerStyle(CustomPoint series, GetPointerStyleEventArgs e)
		{
            ...
            // TODO PEP if(e.Color == var.GetPaletteBasic[0]) { series.Pointer.Pen.Color = var.GetPaletteBasic[0]; }
            // TODO PEP else { series.Pointer.Pen.Color = var.GetPaletteBasic[1]; }
