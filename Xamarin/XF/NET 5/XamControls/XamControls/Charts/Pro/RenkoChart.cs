...
namespace XamControls.Charts.Pro
{
    public class RenkoChart
    {
			...
			public RenkoChart(ChartView BaseChart)
			{
                ...
                BaseChart.Chart.Header.Text = "Renko";
            ...
            // TODO PEP customLeftRenko.AxisPen.Color = customLeftRenko.AxisPen.GetColor().AddLuminosity(-0.2);
            ...
            // TODO PEP customBottomRenko.AxisPen.Color = customBottomRenko.AxisPen.GetColor().AddLuminosity(-0.2);
