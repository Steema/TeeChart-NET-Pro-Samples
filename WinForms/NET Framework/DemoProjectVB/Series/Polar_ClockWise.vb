...
#Region "Designer generated code"
    ...
    Private Sub InitializeComponent()
        ...
        Me.textBox1.Text = "The Polar circle labels can be displayed in ""ClockWise"" orientation." + vbCr + vbLf + vbCr + vbLf + "Example: " + "polarSeries1.ClockWiseLabels = true "
        ' 
        ' panel1
        ' 
        ...
        Me.polarSeries1.Brush.Visible = False
        ...
        Me.checkBox1.Text = "&ClockWise labels"
        ' 
        ' Polar_ClockWise
        ' 
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(466, 286)
        Me.Name = "Polar_ClockWise"
...
#End Region
    ...
    Private Sub checkBox1_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles checkBox1.CheckedChanged
        Me.polarSeries1.ClockWiseLabels = Me.checkBox1.Checked
    End Sub 'checkBox1_CheckedChanged
End Class 'Polar_ClockWise
