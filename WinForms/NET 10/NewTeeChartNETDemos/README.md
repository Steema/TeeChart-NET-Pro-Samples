...
![World Flight Routes](./media/demo2.png ".NET 10 World Flight Routes demo")
...
![Crypto Dashboard](./media/demo3.png ".NET 10 Crypto Dashboard demo")

### Sweeping Heat Map

The sweeping heat map simulates a live frequency display with several moving signal bands.

![Sweeping Heat Map](./media/demo6.png ".NET 10 Sweeping Heat Map demo")
